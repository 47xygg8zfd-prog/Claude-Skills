...
| [`agents/`](agents/) | 26 working Python agents across PM, UX research, data science, design, engineering, marketing, leadership, and strategy — plus PDLC/SDLC orchestrators |
